<template>
    <v-container fluid class="pa-0 pt-4">
        ...
        <MenuButtons ref="menuButtons" @load-new-image="forwardLoadNewImage"
            @load-existing-image="forwardLoadExistingImage" @init-new-quadrat-svg="forwardInitNewQuadratSVG" />

        <v-container class="pa-4">
            <!-- Quadrat name -->
            <v-text-field label="Quadrat Name" v-model="quadratData.name" class="px-5 pt-5 mt-0" dense></v-text-field>

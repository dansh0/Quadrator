  ...
  <v-container fluid class="pa-0 pt-4">
    ...
    <v-container grid-list-md text-s-center>
      <v-row class="justify-center my-2">
        <v-btn large class="black--text mr-10" @click="prevSample" color="primary" :disabled="!isGeoDefined"
          >Prev</v-btn
        >
        <v-btn large class="black--text" color="primary" @click="nextSample" :disabled="!isGeoDefined"
          >Next</v-btn
        >
      </v-row>
